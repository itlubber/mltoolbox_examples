...
class CategoricalDtypeSelector(BaseEstimator, FrameSelectorMixin):
    ...
    ---------
    >>> import pandas as pd
    >>> from mltoolbox.feature_selection import CategoricalDtypeSelector
...
class StringDtypeSelector(BaseEstimator, FrameSelectorMixin):
    ...
    >>> import numpy as np
    >>> import pandas as pd
    >>> from mltoolbox.feature_selection.type_selector import StringDtypeSelector
...
class NumericDtypeSelector(BaseEstimator, FrameSelectorMixin):
    ...
    >>> import numpy as np
    >>> import pandas as po
    >>> from mltoolbox.feature_selection.type_selector import NumericDtypeSelector
