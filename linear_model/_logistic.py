...
class RandomizedLogisticRegression(LogisticRegression):
    ...
    See Also
    ----------
    orca_ml.linear_model.LogisticRegression : learns logistic regression models using the same algorithm.
    """
...
class LogisticRegressionParameterProxy(ModelParameterProxy):
    ...
    >>> from orca_ml.linear_model._logistic import LogisticRegressionParameterProxy
...
class BinaryLogisticRegression(BaseEstimator, ClassifierMixin):
    ...
    >>> from orca_ml.linear_model._logistic import BinaryLogisticRegression
